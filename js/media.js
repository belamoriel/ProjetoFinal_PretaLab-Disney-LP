...
let média = (nota1 + nota2 + nota3 + nota4/ 4)
  ...
  } else if (média >= 0.1 && média <=3) {
    mensagem = "Caramba, deu ruim, você obteve media " + média + "!" + " Estude mais e tente novamente!"
  } else if (média >= 3.1 && média <= 5.9) {
    mensagem = "Você obteve media " + média + "!" + " Falta pouco para a média."
  } else if (média >=6 && média <= 7) {
    mensagem = "Você está na média com " + média + "!" 
  } else if (média >= 7.1 && média <=9.9) {
    mensagem = "Notão! Sua média é " + média + "!"
  } else (média = 10) 
